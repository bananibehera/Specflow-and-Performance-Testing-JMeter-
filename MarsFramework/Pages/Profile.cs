...
namespace MarsFramework
{
    internal class Profile
    {
        ...
        internal void ValidateDescription()
        {
            ...
            //Retrieve the expected Description
            string expectedDescription = GlobalDefinitions.ExcelLib.ReadData(2, "ProfileDescription");

            //Retrieve the Actual Description
            string actualDescription = GlobalDefinitions.driver.FindElement(By.XPath("//h3[text()='Description']/../span")).Text;

            //Validate the Entered Description
            GlobalDefinitions.TextDataFieldValidation("Profile Description", expectedDescription, actualDescription );
